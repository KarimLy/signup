...
<table width="100%" border="0" cellspacing="2" cellpadding="2" summary="table for header">
  <tr>
    <td class="header"><a href="http://www.signupandmakemoney.com/" style="background:none;"><img src="<?php echo URL ?>Assets/signupandmakemoney-logo-lg.jpg" border="0" alt="Signupandmakemoney Logo" title="Signupandmakemoney." style="background:none;" width="300" height="67" /></a></td>
...
<iframe src="http://secretformulawebinar.net/landingpage1.php?user=signupmoney" style="width: 1200px; height: 1450px"></iframe>
   ...
   <form method="POST" target="_blank" action="http://secretformulawebinar.net/getcd.php" id="mainForm">
First Name<br>
...
?>
 ...
 <br /><br /><br /></p>
  ...
  <tr>
    <td colspan="2" class="whitespace"><div align="center" style="padding-left:30px;"><br /><a href="http://www.signupandmakemoney.com/blog/feed/" target="_blank" title="Subscribe to the Signupandmakemoney RSS feed!"><img src="<?php echo URL ?>Assets/rss-large.jpg" alt="Signupandmakemoney RSS feed." width="100" height="100" border="0" style="padding-right:20px;" /></a><a href="https://www.facebook.com/signupmoney" target="_blank" title="Like us at Facebook!"><img src="<?php echo URL ?>Assets/facebook-large.png" alt="Like us on Facebook." width="100" height="100" border="0" style="padding-right:20px;" /></a><a href="http://twitter.com/signupmakemoney" target="_blank" title="Follow us on Twitter!">
    <img src="<?php echo URL ?>Assets/Twitter-large.png" alt="Follow us on Twitter." width="100" height="100" border="0" style="padding-right:20px;" /></a><a href="<?php echo URL ?>/site/affiliates/signup.php#SignupForm" title="Become a Signupandmakemoney affiliate."><img src="<?php echo URL ?>/Assets/affiliate-icon.png" alt="Become a Signupandmakemoney affiliate." width="100" height="100" border="0" /></a><br /><br /><br /><div class="fb-like" data-href="http://www.signupandmakemoney.com" data-send="true" data-width="450" data-show-faces="false"></div>
          <br /><br />
      <table align="center" cellpadding="8" cellspacing="30" border="0" width="600px"><tr><td><div align="center">   
    <div class="fb-like-box" data-href="https://www.facebook.com/signupmoney" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div></div></td><td style="padding-left:15px;"><script type="text/javascript" language="JavaScript" src="http://twittercounter.com/embed/signupmakemoney/ffffff/111111"></script><br /><a href="http://feeds.feedburner.com/signupandmakemoney/haHu" target="_blank"><img src="http://feeds.feedburner.com/~fc/signupandmakemoney/haHu?bg=99CCFF&amp;fg=444444&amp;anim=0" height="26" width="88" style="border:0;" /></a></td></tr><tr><td><br /><div align="center"><?php include('../includes/banner2.php'); ?></div></td>
